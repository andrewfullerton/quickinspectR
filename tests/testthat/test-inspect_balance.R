...
test_that("inspect_balance produces a ggplot object with correct layers", {
  ...
  test_plot_manspec <- inspect_balance(iris_cat3, vars = c("Species", "SepalWidthCategory"), alpha = 0.5)
  ...
  expect_equal(barplot_layer_manspec$aes_params$alpha, 0.5)
})
