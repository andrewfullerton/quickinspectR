...
To get started, we first need load the **quicksinspectR** package into our session. If you don't already it installed, you can use the commented out code below to install the `devtools` package - this lets us install the development version of **quickinspectR** straight from GitHub. 
